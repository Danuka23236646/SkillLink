...
namespace Backend.Migrations
{
    ...
    [Migration("20250904114847_AddEmployerUserIdToJobPosting")]
    partial class AddEmployerUserIdToJobPosting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.EmployerFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_employer_files");

                    b.HasIndex("ProfileId")
                        .HasDatabaseName("ix_employer_files_profile_id");

                    b.ToTable("employer_files", (string)null);
                });
            ...
            modelBuilder.Entity("Backend.Models.EmployerProfile", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_employer_profiles");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_employer_profiles_user_id");
            ...
            modelBuilder.Entity("Backend.Models.JobApplication", b =>
                {
                    ...
                    b.Property<DateTime>("AppliedDateUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("applied_date_utc");
            ...
            modelBuilder.Entity("Backend.Models.JobPosting", b =>
                {
                    ...
                    b.HasIndex("EmployerUserId")
                        .HasDatabaseName("ix_job_postings_employer_user_id");
            ...
            modelBuilder.Entity("Backend.Models.EmployerFile", b =>
                {
                    b.HasOne("Backend.Models.EmployerProfile", "Profile")
                        .WithMany("Files")
                        .HasForeignKey("ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_employer_files_employer_profiles_profile_id");
            ...
            modelBuilder.Entity("Backend.Models.EmployerProfile", b =>
                {
                    b.HasOne("Backend.Models.User", "User")
                        ...
                        .HasConstraintName("fk_employer_profiles_users_user_id");
            ...
            modelBuilder.Entity("Backend.Models.JobApplication", b =>
                {
                    b.HasOne("Backend.Models.JobPosting", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_applications_job_postings_job_id");
            ...
            modelBuilder.Entity("Backend.Models.JobPosting", b =>
                {
                    b.HasOne("Backend.Models.User", "EmployerUser")
                        .WithMany()
                        .HasForeignKey("EmployerUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_job_postings_users_employer_user_id");
